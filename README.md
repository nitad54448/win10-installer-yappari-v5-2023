...
https://latex.codecogs.com/svg.image?Aw&space;=&space;\frac{RT}{{n^2&space;F^2&space;A&space;\sqrt{2}}}&space;\left(\frac{1}{{\sqrt{Do}&space;\cdot&space;Cs_o}}&space;-&space;\frac{1}{{\sqrt{Dr}&space;\cdot&space;Cs_r}}\right)
